<template>
    ...
    <div class="row">
      <div class="col-md-8">
        <div class="form-group">
          ...
          />
          <span v-if="errors.trip_name" class="text-danger">{{ errors.trip_name[0] }}</span>
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          />
          <span v-if="errors.booking_close_date" class="text-danger">{{ errors.booking_close_date[0] }}</span>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          />
          <span v-if="errors.close_trip_booking" class="text-danger">{{ errors.close_trip_booking[0] }}</span>
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="form-group">
          ...
          />
          <span v-if="errors.auto_activation_date" class="text-danger">{{ errors.auto_activation_date[0] }}</span>
    ...
    <button class="btn btn-primary" @click="saveTrip">{{isEditing?'Update':'Save'}}</button>
  </div>
  <!-- input form ends -->
        ...
        <table class="table table-secondary table-bordered">
          ...
          <tbody>
            <tr v-for="(data,index) in list" :key="data.id">
              ...
              <td>
                  <i class="fas fa-trash-alt btn btn-danger text-white btn-sm mx-2" @click="deleteTrip(data.id)"></i>
