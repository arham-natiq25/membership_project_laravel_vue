                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="membershipBuying">How many Memberships do you want to buy ?
                            </label>
                            <!-- Here how many we input it gets in membershipCount  -->
                            <input type="number" class="form-control" id="membershipBuying" name="membershipBuying"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" v-model="items.memberships[i].lname" id="lname"
                                    name="lname" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="date" v-model="items.memberships[i].dob" class="form-control" id="dob"
                                    name="dob" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="radio" class="" v-model="items.memberships[i].gender" :id="'male' + i"
                                    value="male" :name="'gender' + i" />
                                Male
                                <input type="radio" class="" :id="'female' + i" value="female"
                                    v-model="items.memberships[i].gender" :name="'gender' + i" />
                                Female
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-check">
                                ...
                                <input type="radio" class="" :id="'skier' + i" value="skier" :name="'activity' + i"
                                    v-model="items.memberships[i].activity" />
                                Skier
                                <input type="radio" class="" :id="'snowboarder' + i" value="snowboarder"
                                    :name="'activity' + i" v-model="items.memberships[i].activity" />
                                SnowBoarder
                            </div>
                        </div>
                        <hr v-if="i < parseInt(membershipCount) - 1" />
                        <div class="col-md-4 mt-4">
                            <button v-if="i === parseInt(membershipCount) - 1" class="btn btn-primary" @click="memberSave">
                                NEXT PAGE
                            </button>
                        </div>
                    </div>
                    ...
                    .catch((error) => {
                        ...
                        if (error.response && error.response.data.error) {
                            ...
                            for (const key in backendErrors) {
                                ...
                                if (index && fieldName) {
                                    const errorMessage = `${fieldName} for member ${parseInt(index[0]) + 1
                                        } is required`;
